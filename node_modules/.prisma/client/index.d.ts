  ...
  */
    ...
    model: {
      ...
      Transaksi: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.TransaksiFindRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          aggregateRaw: {
            args: Prisma.TransaksiAggregateRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          count: {
  ...
  export interface TransaksiDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Find zero or more Transaksis that matches the filter.
     * @param {TransaksiFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const transaksi = await prisma.transaksi.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: TransaksiFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Transaksi.
     * @param {TransaksiAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const transaksi = await prisma.transaksi.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
    ...
    **/
    aggregateRaw(
      args?: TransaksiAggregateRawArgs
    ): Prisma.PrismaPromise<JsonObject>
   ...
   * Transaksi findRaw
   */
  export type TransaksiFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Transaksi aggregateRaw
   */
  export type TransaksiAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
